$(function() {
    ...
    t++, localStorage.setItem("theme-index", t), $(".documentation").addClass("theme-" + n.name), $(".documentation-header").vegas({
        ...
        var e;
        s.preventDefault(), $(".overlay-list li").removeClass("active"), e = $(this).attr("class").replace("overlay-", ""), e = "../css/overlays/" + e + ".png", $(this).addClass("active"), $("#test2-4 .vegas-overlay").css("background-image", "url(" + e + ")"), $("#code-overlay").text("'" + e + "'")
