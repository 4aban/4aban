!function(t) {
    ...
    function j() {
        if (this.target = null, this.element = null, this.dropTarget = null, this.dropElement = null, this.prevDropTarget = null, this.prevDropElement = null, this.prepared = {
            ...
            this.boundInertiaFrame = this.inertiaFrame.bind(this), this.boundSmoothEndFrame = this.smoothEndFrame.bind(this);
        else {
            var t = this;
    ...
    function B(t, e, i) {
        ...
        if (o || !ke && !Xe) {
            for (s = 0; n > s; s++)
                if (Me[s].mouse && !Me[s].inertiaStatus.active)
                    return Me[s];
            for (s = 0; n > s; s++)
                if (Me[s].mouse && (!/down/.test(e) || !Me[s].inertiaStatus.active))
                    return r;
            return r = new j, r.mouse = !0, r
        }
        for (s = 0; n > s; s++)
            if (ce(Me[s].pointerIds, a))
                return Me[s];
        if (/up|end|out/i.test(e))
            return null;
        for (s = 0; n > s; s++)
            if (r = Me[s], !(r.prepared.name && !r.target.options.gesture.enabled || r.interacting() || !o && r.mouse))
                return r;
        return new j
    }
    function K(t) {
        return function(e) {
            var i,
                ...
                n = w(e.currentTarget);
            if (ke && /touch/.test(e.type))
                for (Ie = (new Date).getTime(), r = 0; r < e.changedTouches.length; r++) {
                ...
                if (!Xe && /mouse/.test(e.type)) {
                    for (r = 0; r < Me.length; r++)
                        if (!Me[r].mouse && Me[r].pointerIsDown)
                            return;
                    if ((new Date).getTime() - Ie < 500)
                        return
                }
                if (i = B(e, e.type, s), !i)
                    return;
    ...
    function Z(t) {
        var e = "";
        if ("drag" === t.name && (e = qe.drag), "resize" === t.name)
            if (t.axis)
                e = qe[t.name + t.axis];
            else if (t.edges) {
    ...
    function te(t, e, r, s, n, o, a) {
        ...
        if (e === !0) {
            ...
            if (0 > p && ("left" === t ? t = "right" : "right" === t && (t = "left")), 0 > l && ("top" === t ? t = "bottom" : "bottom" === t && (t = "top")), "left" === t)
                return r.x < (p >= 0 ? o.left : o.right) + a;
            if ("top" === t)
                return r.y < (l >= 0 ? o.top : o.bottom) + a;
            if ("right" === t)
                return r.x > (p >= 0 ? o.right : o.left) - a;
            if ("bottom" === t)
                return r.y > (l >= 0 ? o.bottom : o.top) - a
        }
    ...
    function ee(t, e, i) {
        ...
        if (Ne.resize && l.resize.enabled) {
            ...
            if (r = {
                ...
                for (var u in r)
                    r[u] = te(u, c.edges[u], p, e._eventTarget, i, s, c.margin || Ye);
                r.left = r.left && !r.right, r.top = r.top && !r.bottom, n = r.left || r.right || r.top || r.bottom
            } else {
                var g = "y" !== l.resize.axis && p.x > s.right - Ye,
                    v = "x" !== l.resize.axis && p.y > s.bottom - Ye;
                n = g || v, h = (g ? "x" : "") + (v ? "y" : "")
            }
        }
    ...
    function oe(t, e) {
        ...
        if (c(t)) {
            ...
            r = z(t), i(t, r) && (we ? (Be.add(this._element, ge.down, Je.pointerDown), Be.add(this._element, ge.move, Je.pointerHover)) : (Be.add(this._element, "mousedown", Je.pointerDown), Be.add(this._element, "mousemove", Je.pointerHover), Be.add(this._element, "touchstart", Je.pointerDown), Be.add(this._element, "touchmove", Je.pointerHover)));
    ...
    function pe(t) {
        if (!ce(Te, t)) {
            ...
            Be.add(t, "dragstart", function(t) {
                for (var e = 0; e < Me.length; e++) {
                    var i = Me[e];
                    if (i.element && (i.element === t.target || R(i.element, t.target)))
                        return void i.checkAndPreventDefault(t, i.target, i.element)
                }
    ...
    if (t) {
        var ge,
            ...
            fe = me.document,
            ye = me.DocumentFragment || e,
            xe = me.SVGElement || e,
            Ee = me.SVGSVGElement || e,
            Se = me.SVGElementInstance || e,
            be = me.HTMLElement || me.Element,
            we = me.PointerEvent || me.MSPointerEvent,
            ze = Math.hypot || function(t, e) {
            ...
            _e = {
                ...
                scroll: function() {
                    var t,
                        ...
                        i,
                        s,
                        n = _e.interaction.target.options[_e.interaction.prepared.name].autoScroll,
                        o = n.container || z(_e.interaction.element),
                        a = (new Date).getTime(),
                        h = (a - _e.prevTimeX) / 1e3,
                        p = (a - _e.prevTimeY) / 1e3;
            ...
            ke = "ontouchstart" in me || me.DocumentTouch && fe instanceof me.DocumentTouch,
            Xe = !!we,
            Ye = ke || Xe ? 20 : 10,
            Re = 1,
            Ie = 0,
            ...
            He = "onmousewheel" in fe ? "mousewheel" : "wheel",
            ...
            Ue = {},
            Ve = "Opera" == navigator.appName && ke && navigator.userAgent.match("Presto"),
            ...
            Be = function() {
                ...
                function e(t, i, r, s) {
                    var o,
                        ...
                        m = r;
                    if (v && v.events)
                        if (n && (d = c[g], u = le(d.supplied, r), m = d.wrapped[u]), "all" !== i) {
                            if (v.events[i]) {
                ...
                var n = "attachEvent" in me && !("addEventListener" in me),
        ...
        j.prototype = {
            ...
            pointerOver: function(t, e, i) {
                ...
                if (!this.prepared.name && this.mouse) {
                    ...
                    var a = Ce.get(i),
                        h = a && !N(a, i, i) && H(a, i, i) && ie(a.getAction(t, e, this, i), a);
            ...
            selectorDown: function(t, e, r, s) {
                ...
                var o,
                    a = this,
                    h = Be.useAttachEvent ? d({}, e) : e,
                    p = r,
                    l = this.addPointer(t);
                if (this.holdTimers[l] = setTimeout(function() {
                    a.pointerHold(Be.useAttachEvent ? h : t, h, r, s)
                }, Oe._holdDuration), this.pointerIsDown = !0, this.inertiaStatus.active && this.target.selector)
                    for (; i(p);) {
                        if (p === this.element && ie(this.target.getAction(t, e, this, this.element), this.target).name === this.prepared.name)
                            return je(this.inertiaStatus.i), this.inertiaStatus.active = !1, void this.collectEventTargets(t, e, r, "down");
                        p = F(p)
                    }
                if (this.interacting())
                    return void this.collectEventTargets(t, e, r, "down");
                for (this.setEventXY(this.curCoords, [t]), this.downEvent = e; i(p) && !o;)
                    this.matches = [], this.matchElements = [], Ce.forEachSelector(n), o = this.validateSelector(t, e, this.matches, this.matchElements), p = F(p);
            ...
            pointerDown: function(t, e, i, r, s) {
                ...
                if (!p || !s && this.prepared.name)
                    this.inertiaStatus.active && r === this.element && ie(p.getAction(t, e, this, this.element), p).name === this.prepared.name && (je(this.inertiaStatus.i), this.inertiaStatus.active = !1, this.checkAndPreventDefault(e, p, this.element));
                else {
                    if (n = n || ie(s || p.getAction(t, e, this, r), p, this.element), this.setEventXY(this.startCoords, this.pointers), !n)
                        return;
            ...
            pointerMove: function(t, e, r, s, n) {
                if (this.inertiaStatus.active) {
                    ...
                    this.recordPointer(t), this.setEventXY(this.curCoords, this.pointers);
                var p,
                    l,
                ...
                if (this.pointerIsDown && !this.pointerWasMoved && (p = this.curCoords.client.x - this.startCoords.client.x, l = this.curCoords.client.y - this.startCoords.client.y, this.pointerWasMoved = ze(p, l) > Re), c || this.pointerIsDown && !this.pointerWasMoved || (this.pointerIsDown && clearTimeout(this.holdTimers[d]), this.collectEventTargets(t, e, r, "move")), this.pointerIsDown) {
                    ...
                    if (m(this.pointerDelta, this.prevCoords, this.curCoords), this.prepared.name) {
                        if (this.pointerWasMoved && (!this.inertiaStatus.active || t instanceof J && /inertiastart/.test(t.type))) {
                                    ...
                                    if (!this.prepared.name) {
                                        var S = this,
                                            w = function(t, e, i) {
                                                var s = ve ? i.querySelectorAll(e) : void 0;
                                                if (t !== S.target)
                                                    return q(t, r) && !t.options.drag.manualStart && !N(t, x, r) && H(t, x, r) && de(x, e, s) && "drag" === t.getAction(S.downPointer, S.downEvent, S, x).name && W(y, t) && G(t, x, "drag") ? t : void 0
                                            };
                                        for (x = r; i(x);) {
                            ...
                            if (D && (this.target.options[this.prepared.name].manualStart || !G(this.target, this.element, this.prepared)))
            ...
            resizeMove: function(t) {
                ...
                if (i) {
                    ...
                    if (this.target.options.resize.preserveAspectRatio) {
                        ...
                        this.target.options.resize.square && (i = this.prepared._linkedEdges, u.left && u.bottom || u.right && u.top ? o = -n : u.left || u.right ? o = n : (u.top || u.bottom) && (n = o));
                    if (i.top && (h.top += o), i.bottom && (h.bottom += o), i.left && (h.left += n), i.right && (h.right += n), s) {
                        ...
                        p.top = Math.min(h.top, a.bottom), p.bottom = Math.max(h.bottom, a.top), p.left = Math.min(h.left, a.right), p.right = Math.max(h.right, a.left);
            ...
            pointerEnd: function(t, e, i, r) {
                ...
                if (this.interacting()) {
                    ...
                    var p,
                        ...
                        y = V(n, this.prepared.name) && o[this.prepared.name].restrict.endOnly,
                        x = 0,
                        E = 0;
                    ...
                    if (v || m) {
                        if (g(h.upCoords, this.curCoords), this.pointers[0] = h.startEvent = l = new J(this, e, this.prepared.name, "inertiastart", this.element), h.t0 = c, n.fire(h.startEvent), v) {
                            ...
                            h.smoothEnd = !0, h.xe = x, h.ye = E, h.sx = h.sy = 0, h.i = Le(this.boundSmoothEndFrame);
                ...
                if (this.dragging) {
                    ...
                    this.resizing ? (s = new J(this, e, "resize", "end", this.element), n.fire(s)) : this.gesturing && (s = new J(this, e, "gesture", "end", this.element), n.fire(s));
                this.stop(e)
            },
            collectDrops: function(t) {
                var e,
                    r = [],
                    s = [];
                for (t = t || this.element, e = 0; e < Ce.length; e++)
                    if (Ce[e].options.drop.enabled) {
                        var n = Ce[e],
                            o = n.options.drop.accept;
                        if (!(i(o) && o !== t || l(o) && !de(t, o)))
            ...
            fireActiveDrops: function(t) {
                ...
                for (e = 0; e < this.activeDrops.dropzones.length; e++)
                    i = this.activeDrops.dropzones[e], r = this.activeDrops.elements[e], r !== s && (t.target = r, i.fire(t)), s = r
            },
            ...
            getDrop: function(t, e, i) {
                ...
                var h = L(r),
                    p = this.activeDrops.dropzones[h] || null,
                    l = this.activeDrops.elements[h] || null;
                return {
                    dropzone: p,
                    element: l
                }
            ...
            stop: function(t) {
                ...
                for (var i = 0; i < this.pointers.length; i++)
                    -1 === le(this.pointerIds, b(this.pointers[i])) && this.pointers.splice(i, 1)
            },
            inertiaFrame: function() {
                ...
                if (r < t.te) {
                    ...
                    t.ending = !0, t.sx = t.modifiedXe, t.sy = t.modifiedYe, this.pointerMove(t.startEvent, t.startEvent), this.pointerEnd(t.startEvent, t.startEvent), t.active = t.ending = !1
            },
            ...
            addPointer: function(t) {
                var e = b(t),
                    i = this.mouse ? 0 : le(this.pointerIds, e);
            ...
            collectEventTargets: function(t, e, r, s) {
                ...
                if ("tap" !== s || !this.pointerWasMoved && this.downTargets[o] && this.downTargets[o] === r) {
                    for (var a = [], h = [], p = r; p;)
                        ne.isSet(p) && ne(p)._iEvents[s] && (a.push(ne(p)), h.push(p)), Ce.forEachSelector(n), p = F(p);
            ...
            firePointers: function(t, e, i, r, s, n) {
                var o,
                    a,
                    h,
                    p = this.mouse ? 0 : le(this.pointerIds, b(t)),
                    c = {};
            ...
            setSnapping: function(t, e) {
                var i,
                    ...
                    o = [];
                if (e = e || this.snapStatus, e.useStatusXY)
                    r = {
                        x: e.x,
                        y: e.y
                    };
                ...
                for (var l = n.targets ? n.targets.length : 0, c = 0; c < this.snapOffsets.length; c++) {
                    ...
                    for (s = 0; l > s; s++)
                        i = a(n.targets[s]) ? n.targets[s](u.x, u.y, this) : n.targets[s], i && o.push({
            ...
            autoScrollMove: function(t) {
                if (this.interacting() && $(this.target, this.prepared.name)) {
                    if (this.inertiaStatus.active)
                        return void (_e.x = _e.y = 0);
                    var e,
                        i,
                        s,
                        n,
                        o = this.target.options[this.prepared.name].autoScroll,
                        a = o.container || z(this.element);
                    if (r(a))
                        n = t.clientX < _e.margin, e = t.clientY < _e.margin, i = t.clientX > a.innerWidth - _e.margin, s = t.clientY > a.innerHeight - _e.margin;
                    else {
                        var h = D(a);
        ...
        Ce.indexOfElement = function(t, e) {
            ...
            setPerAction: function(t, e) {
                for (var i in e)
                    i in Oe[t] && (o(e[i]) ? (this.options[t][i] = d(this.options[t][i] || {}, e[i]), o(Oe.perAction[i]) && "enabled" in Oe.perAction[i] && (this.options[t][i].enabled = e[i].enabled === !1 ? !1 : !0)) : p(e[i]) && o(Oe.perAction[i]) ? this.options[t][i].enabled = e[i] : void 0 !== e[i] && (this.options[t][i] = e[i]))
            },
            dropzone: function(t) {
            ...
            dropCheck: function(t, e, i, r, s, n) {
                ...
                if (!(n = n || this.getRect(s)))
                    return this.options.drop.checker ? this.options.drop.checker(t, e, o, this, s, i, r) : !1;
            ...
            setOptions: function(t, e) {
                ...
                for (i = 0; i < l.length; i++)
                    t in Oe[l[i]] && (h[l[i]] = this.options[l[i]][t]);
                return h
            },
            inertia: function(t) {
            ...
            fire: function(t) {
                ...
                if (t.type in this._iEvents)
                    for (e = this._iEvents[t.type], i = 0, r = e.length; r > i && !t.immediatePropagationStopped; i++)
                        n = e[i].name, e[i](t);
                if (a(this[s]) && (n = this[s].name, this[s](t)), t.type in Ue && (e = Ue[t.type]))
                    for (i = 0, r = e.length; r > i && !t.immediatePropagationStopped; i++)
                        n = e[i].name, e[i](t);
                return this
            },
            on: function(t, e, i) {
                ...
                if ("wheel" === t && (t = He), i = i ? !0 : !1, ce(We, t))
                    ...
                    if (!Ae[t])
                        for (Ae[t] = {
                            ...
                            Be.add(Te[r], t, re), Be.add(Te[r], t, se, !0);
                    var a,
                        h = Ae[t];
            ...
            off: function(t, e, i) {
                ...
                var a,
                    h = -1;
                if (i = i ? !0 : !1, "wheel" === t && (t = He), ce(We, t))
                    a = this._iEvents[t], a && -1 !== (h = le(a, e)) && this._iEvents[t].splice(h, 1);
                else if (this.selector) {
                    var p = Ae[t],
                        c = !1;
                    if (!p)
            ...
            unset: function() {
                if (Be.remove(this._element, "all"), l(this.selector))
                    for (var t in Ae)
                        for (var e = Ae[t], i = 0; i < e.selectors.length; i++) {
                    ...
                    Be.remove(this, "all"), this.options.styleCursor && (this._element.style.cursor = "");
            ...
            for (var e = 0, i = ["ms", "moz", "webkit", "o"], r = 0; r < i.length && !t.requestAnimationFrame; ++r)
                Le = t[i[r] + "RequestAnimationFrame"], je = t[i[r] + "CancelAnimationFrame"] || t[i[r] + "CancelRequestAnimationFrame"];
            Le || (Le = function(t) {
