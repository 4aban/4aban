...
!function(a, b) {
    ...
    var a = window.AudioContext || window.webkitAudioContext,
        b = {
            ...
            sound: function(a, c) {
                ...
                if (this.load = function() {
                    ...
                    for (var k in b.defaults)
                        b.defaults.hasOwnProperty(k) && void 0 === c[k] && (c[k] = b.defaults[k]);
                    ...
                    if (a instanceof Array)
                        for (var m in a)
                            a.hasOwnProperty(m) && this.addSource(a[m]);
                    else if (c.formats.length)
                        for (var n in c.formats)
                            c.formats.hasOwnProperty(n) && this.addSource(a + "." + c.formats[n]);
                    else
                        this.addSource(a);
            ...
            group: function(a) {
                function b() {
                    for (var b = c(null, arguments), d = b.shift(), e = 0; e < a.length; e++)
                        a[e][d].apply(a[e], b)
                }
                function c(a, b) {
